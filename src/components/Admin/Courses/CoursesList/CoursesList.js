...
import { getCoursesDataUdemyApi, deleteCoursesApi, updateCourseApi } from "../../../../api/courses";
...
export default function CoursesList(props){
    ...
    const deleteCourse = course => {
        ...
        confirm({
            ...
            content: `¿Estas seguro de querer eliminar el curso ${course.idCourse}?`,
            okText: "Eliminar",
            okType: "danger",
            cancelText: "Cancelar",
            onOk(){
                deleteCoursesApi(accesToken, course._id)
                    .then(response => {
